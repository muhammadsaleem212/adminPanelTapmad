...
@section('action-content')
  ...
  <div id="app">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 text-right">
          <a href="{{url('saveUserSubscription')}}" class="btn btn-primary">Add Subscription by Number</a>
          <a href="{{url('userSubscription/create')}}" class="btn btn-success">Add Subscription by ACR</a>
        </div>
  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{url('userSubscription/search')}}">
         {{ csrf_field() }}
