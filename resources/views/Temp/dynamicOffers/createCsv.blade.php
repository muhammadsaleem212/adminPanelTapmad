        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('Admin/Marketing/dynamicOffers/store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('packageCode') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                            <input id="packageCode" type="text" class="form-control" name="packageCode" value="{{ old('packageCode') }}" required autofocus>
