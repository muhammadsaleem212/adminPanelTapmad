        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('Admin/Users/UserManagementController/update', ['id' => $user->id]) }}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="userRoleID">
                                    @foreach ($roles as $role)
                                        <option value="{{$role->id}}" {{$role->id == $user->user_role_id ? 'selected' : ''}}>{{$role->userRolesName}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
