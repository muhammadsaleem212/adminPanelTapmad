...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-6 text-right">
          <a href="{{url('/Admin/Marketing/promoCode/create')}}" class="btn btn-primary">Add new Promo Code</a>
        </div>
  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{url('/Admin/Marketing/promoCode/search')}}">
         {{ csrf_field() }}
      </form>
      <section class="content">
      <div class="row">
          ...
          <div class="box">
            ...
            @foreach ($promoCode as $promo)
                <tr class="odd">
                  ...
                  <td>
                    <form class="row" method="POST" action="{{ url ('Admin/Marketing/promoCode/destroy',$promoCode[0]['PromoCodeId']) }}" onsubmit = "return confirm('Are you sure?')">
                        <input type="hidden" name="_method" value="DELETE">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <a href="{{ url ('Admin/Marketing/promoCode/edit', ['id' => $promo->PromoCodeId]) }}" class="btn btn-warning col-sm-4 col-xs-5 btn-margin">
                        Update
                        </a>
