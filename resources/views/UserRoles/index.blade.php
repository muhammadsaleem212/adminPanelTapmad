...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-4">
          <a class="btn btn-primary" href="{{ url('saveUserRoles') }}">Add new user Role</a>
        </div>
    </div>
  </div>
  <!-- /.box-header -->
                ...
                <tr class="odd">
                  ...
                  <td>
                    <form class="row" method="POST" action="{{ url('userRoles/destroy', ['id' => $roles->userRolesID]) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="{{ url('userRoles/edit', ['id' => $roles->id]) }}" class="btn btn-warning col-sm-3 col-xs-5 btn-margin">
                        Update
                        </a>
