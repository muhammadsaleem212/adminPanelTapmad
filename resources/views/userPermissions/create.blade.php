        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('userPermissions/store') }}">
                        {{ csrf_field() }}
                        ...
                        <br><span><input type="checkbox" name="userScreenID[]" value = {{$screens->id}}> Screen Rights</span>
                    </div>
                    <br>    
                        </div>
                        @endforeach
